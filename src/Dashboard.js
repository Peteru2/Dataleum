        ...
        <>
            ...
            <section className="px-16 mt-32">
                ...
                <div className="mx-20 mt-6">
                    <div className="flex justify-between flex-wrap dashPlan">                   
                    <div className=" bg-white shadow-lg w-96 h-50 rounded-lg py-8 px-14 ">
                    ...
                    <div className="justify-content bg-white shadow-lg w-96  h-50 rounded-lg py-8 px-14 ">
                ...
                <div className="mt-20">
                    <p>
                        <span className="font-bold mr-6 text-2xl">All Transaction</span> <span className="text-gray-400 font-bold mr-6 text-2xl">Succesful</span><span  className="text-gray-400 font-bold  text-2xl">Failed</span>
                    </p>
                    <div className="mt-5">
